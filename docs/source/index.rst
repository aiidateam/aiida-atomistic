The aiida-atomistic plugin for `AiiDA`_
=====================================================
...
Please contact mikibonacci@psi.ch for information concerning ``aiida-atomistic`` and the `AiiDA mailing list <http://www.aiida.net/mailing-list/>`_ for questions concerning ``aiida``.
